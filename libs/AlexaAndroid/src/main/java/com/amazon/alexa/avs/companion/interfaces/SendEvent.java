...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.amazon.alexa.avs.companion.data.Directive} or {@link com.amazon.alexa.avs.companion.data.Event} URL
    ...
    /**
     * Get our JSON {@link com.amazon.alexa.avs.companion.data.Event} for this call
     * @return the JSON representation of the {@link com.amazon.alexa.avs.companion.data.Event}
     */
    @NotNull
