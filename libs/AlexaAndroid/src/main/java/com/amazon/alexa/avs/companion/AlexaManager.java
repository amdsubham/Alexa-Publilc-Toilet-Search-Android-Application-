...
import com.amazon.alexa.avs.companion.callbacks.AsyncCallback;
import com.amazon.alexa.avs.companion.callbacks.AuthorizationCallback;
import com.amazon.alexa.avs.companion.data.Event;
import com.amazon.alexa.avs.companion.interfaces.AvsException;
import com.amazon.alexa.avs.companion.interfaces.AvsItem;
import com.amazon.alexa.avs.companion.interfaces.AvsResponse;
import com.amazon.alexa.avs.companion.interfaces.GenericSendEvent;
import com.amazon.alexa.avs.companion.interfaces.audioplayer.AvsPlayAudioItem;
import com.amazon.alexa.avs.companion.interfaces.response.ResponseParser;
import com.amazon.alexa.avs.companion.interfaces.speechrecognizer.SpeechSendAudio;
import com.amazon.alexa.avs.companion.interfaces.speechrecognizer.SpeechSendText;
import com.amazon.alexa.avs.companion.interfaces.speechrecognizer.SpeechSendVoice;
import com.amazon.alexa.avs.companion.interfaces.speechsynthesizer.AvsSpeakItem;
import com.amazon.alexa.avs.companion.requestbody.DataRequestBody;
import com.amazon.alexa.avs.companion.service.DownChannelService;
import com.amazon.alexa.avs.companion.system.AndroidSystemHandler;
import com.amazon.alexa.avs.companion.utility.Util;
...
import static com.amazon.alexa.avs.companion.AuthorizationManager.createCodeVerifier;
import static com.amazon.alexa.avs.companion.interfaces.response.ResponseParser.getBoundary;
import static com.amazon.alexa.avs.companion.utility.Util.IDENTIFIER;
...
public class AlexaManager {
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending {@link com.amazon.alexa.avs.companion.data.Directive}
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.amazon.alexa.avs.companion.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.amazon.alexa.avs.companion.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.amazon.alexa.avs.companion.data.Event.Builder}
