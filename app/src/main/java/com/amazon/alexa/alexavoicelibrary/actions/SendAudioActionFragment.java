...
import com.amazon.alexa.alexavoicelibrary.BuildConfig;
import com.amazon.alexa.alexavoicelibrary.R;
import com.amazon.alexa.recorderview.RecorderView;
...
public class SendAudioActionFragment extends BaseListenerFragment {
    ...
    private RecorderView recorderView;
     ...
     private Button getlocation,putmarker;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Button getlocation=(Button)view.findViewById(R.id.getlocation);
        ...
        putmarker=(Button)view.findViewById(R.id.putLocation);

        putmarker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
